...
puts "Start database creation... "
  ...
  dinosaure = Costume.create!(owner: joris, price_per_day: 20, description: "Ce costume sera du meilleur effet en soirée ! (PS: N'oublie pas ton gonfleur)", name: "Dinosaur", photo: File.open(Rails.root.join('db/fixtures/costumes/cowboy.jpg')))
